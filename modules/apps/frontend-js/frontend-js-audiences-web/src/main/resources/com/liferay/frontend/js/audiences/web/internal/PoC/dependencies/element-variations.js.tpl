...
const AUDIENCE_ID_FIREFOX = 'the_audience';
...
const AUDIENCE_ID_SIGNED_IN = 'signed_in_user';

audiences.on(
	AUDIENCE_ID_SIGNED_IN,
	function showSignedInMessage() {
		const MESSAGE_ID = 'signed_in_message';
		...
		message.id = MESSAGE_ID;
		message.style.color = 'white';
		message.style.backgroundColor = '#00C000';
		message.style.paddingBottom = '1em';
		message.style.paddingTop = '1em';
		message.style.textAlign = 'center';

		message.innerHTML = `Hey, we see you are logged in!`;

		div.appendChild(message);
	}
);

const AUDIENCE_ID_DESKTOP_USER = 'desktop_user';

audiences.on(
	AUDIENCE_ID_DESKTOP_USER,
	function showDesktopUserMessage() {
		const MESSAGE_ID = 'desktop_user_message';
		...
		message.innerHTML = `Hey, we see you are a desktop user!`;

		div.appendChild(message);
	}
);

const AUDIENCE_ID_EVENING = 'evening';

audiences.on(
	AUDIENCE_ID_EVENING,
	function showDesktopUserMessage() {
		const MESSAGE_ID = 'evening_message';
		...
		message.innerHTML = `Hey, we see you are enjoying the evening!`;
