...
public class FrontendJSAudiencesWebTopHeadDynamicInclude
	...
	public void include(
		...
		// Element variations are page specific. The SPA engine replaces the
		// document's meta tags on every navigation, so the current page's
		// variations are published here for the bootstrap script to read.
		...
		// The bootstrap script is loaded once. It runs detection and applies
		// the current page's variations, repeating both on every SPA
		// navigation.
